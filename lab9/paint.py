...
image_rectangle = load_and_resize_image("rectangle.png")
image_circle = load_and_resize_image("circle.png")
image_square = load_and_resize_image("square.png")
image_triangle = load_and_resize_image("triangle.png")
image_equilateral_triangle = load_and_resize_image("eq_triangle.png")
image_rhombus = load_and_resize_image("rhombus.png")
